...
from custom_components.google_assistant import DOMAIN as GOOGLE_DOMAIN
from custom_components.google_assistant.helpers import (  # pylint: disable=hass-component-root-import
    AbstractConfig,
)
